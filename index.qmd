...
This repository contains data and code for reproducing a study on the use of *arch-* in present-day English. The data come from the ENCOW corpus (@schaferBuildingLargeCorpora2012) described [here](https://web.archive.org/web/20210924132944/https://corporafromtheweb.org/encow16/).
